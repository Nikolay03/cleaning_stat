...
const ServiceBottomWave = ({ color, ...props }) => {
  return (
    <SvgIcon fill={color} viewBox={'0 0 1000 100'} preserveAspectRatio={'none'} xmlns={'http://www.w3.org/2000/svg'} {...props}>
...
export default ServiceBottomWave
